...
bcftools view -i 'FORMAT/DP[0:0] > 10 & FORMAT/AD[0:1] > 4 & FORMAT/AF[0:0] > 0.05 & INFO/MBQ[1] > 20 & INFO/MMQ[1] > 50 & INFO/MPOS > 5' ${data_path}/${project}/${subject}/${sample}/${VEPInputVcf} > ${data_path}/${project}/${subject}/${sample}/${VEPInputVcf/.vcf/.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.vcf} 
...
bcftools view -i 'FORMAT/DP[0:0] > 10 & FORMAT/AD[0:1] > 4 & FORMAT/AF[0:0] > 0.05 & INFO/MBQ[1] > 20 & INFO/MMQ[1] > 50 & INFO/MPOS > 5' > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.non_synonymous_variant_only.vcf}
bcftools query -f "%CHROM\t%POS\t%REF\t%ALT{0}\t%DP\t[%GT\t%AD{0}\t%AD{1}\t%AF\t]\t%MBQ[1]\t%MMQ[1]\t%MPOS\t\n" ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.non_synonymous_variant_only.vcf} > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.non_synonymous_variant_only.query}

singularity exec --bind ${data_path}/${project}/${subject}/${sample}:/data \
/data/ldiaz/luol2/ensembl-vep.sif \
filter_vep -i /data/${VEPOutputVcf} --filter "Consequence is missense_variant" | \
bcftools view -i 'FORMAT/DP[0:0] > 10 & FORMAT/AD[0:1] > 4 & FORMAT/AF[0:0] > 0.05 & INFO/MBQ[1] > 20 & INFO/MMQ[1] > 50 & INFO/MPOS > 5' > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.missense_variant_only.vcf}
bcftools query -f "%CHROM\t%POS\t%REF\t%ALT{0}\t%DP\t[%GT\t%AD{0}\t%AD{1}\t%AF\t]\t%MBQ[1]\t%MMQ[1]\t%MPOS\t\n" ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.missense_variant_only.vcf} > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.missense_variant_only.query}

singularity exec --bind ${data_path}/${project}/${subject}/${sample}:/data \
/data/ldiaz/luol2/ensembl-vep.sif \
filter_vep -i /data/${VEPOutputVcf} --filter "Consequence is frameshift_variant" | \
bcftools view -i 'FORMAT/DP[0:0] > 10 & FORMAT/AD[0:1] > 4 & FORMAT/AF[0:0] > 0.05 & INFO/MBQ[1] > 20 & INFO/MMQ[1] > 50 & INFO/MPOS > 5' > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.frameshift_variant_only.vcf}
bcftools query -f "%CHROM\t%POS\t%REF\t%ALT{0}\t%DP\t[%GT\t%AD{0}\t%AD{1}\t%AF\t]\t%MBQ[1]\t%MMQ[1]\t%MPOS\t\n" ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.frameshift_variant_only.vcf} > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.frameshift_variant_only.query}

singularity exec --bind ${data_path}/${project}/${subject}/${sample}:/data \
/data/ldiaz/luol2/ensembl-vep.sif \
filter_vep -i /data/${VEPOutputVcf} --filter "Consequence is synonymous_variant" | \
bcftools view -i 'FORMAT/DP[0:0] > 10 & FORMAT/AD[0:1] > 4 & FORMAT/AF[0:0] > 0.05 & INFO/MBQ[1] > 20 & INFO/MMQ[1] > 50 & INFO/MPOS > 5' > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.synonymous_variant_only.vcf}
bcftools query -f "%CHROM\t%POS\t%REF\t%ALT{0}\t%DP\t[%GT\t%AD{0}\t%AD{1}\t%AF\t]\t%MBQ[1]\t%MMQ[1]\t%MPOS\t\n" ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.synonymous_variant_only.vcf} > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.05_MBQ20_MMQ50_MPOS5.synonymous_variant_only.query}

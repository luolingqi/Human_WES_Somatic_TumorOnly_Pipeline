...
#targeted_sequencing.tumor_only.gatk4_mutect2.raw_somatic_mutation.rm_dbsnps.vcf.gz
...
bcftools view -i 'FORMAT/DP[0:0] > 10 & FORMAT/AD[0:1] > 4 & FORMAT/AF[0:0] > 0.01 & INFO/MBQ[1] > 20 & INFO/MMQ[1] > 50 & INFO/MPOS > 5' ${data_path}/${project}/${subject}/${sample}/${VEPInputVcf} > ${data_path}/${project}/${subject}/${sample}/${VEPInputVcf/.vcf/.altAD4_AF0.01_MBQ20_MMQ50_MPOS5.vcf} 
...
bcftools view -i 'FORMAT/DP[0:0] > 10 & FORMAT/AD[0:1] > 4 & FORMAT/AF[0:0] > 0.01 & INFO/MBQ[1] > 20 & INFO/MMQ[1] > 50 & INFO/MPOS > 5' > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.01_MBQ20_MMQ50_MPOS5.non_synonymous_variant_only.vcf}
...
bcftools view -i 'FORMAT/DP[0:0] > 10 & FORMAT/AD[0:1] > 4 & FORMAT/AF[0:0] > 0.01 & INFO/MBQ[1] > 20 & INFO/MMQ[1] > 50 & INFO/MPOS > 5' > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.01_MBQ20_MMQ50_MPOS5.missense_variant_only.vcf}
...
bcftools view -i 'FORMAT/DP[0:0] > 10 & FORMAT/AD[0:1] > 4 & FORMAT/AF[0:0] > 0.01 & INFO/MBQ[1] > 20 & INFO/MMQ[1] > 50 & INFO/MPOS > 5' > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.01_MBQ20_MMQ50_MPOS5.frameshift_variant_only.vcf}
...
bcftools view -i 'FORMAT/DP[0:0] > 10 & FORMAT/AD[0:1] > 4 & FORMAT/AF[0:0] > 0.01 & INFO/MBQ[1] > 20 & INFO/MMQ[1] > 50 & INFO/MPOS > 5' > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.altAD4_AF0.01_MBQ20_MMQ50_MPOS5.synonymous_variant_only.vcf}

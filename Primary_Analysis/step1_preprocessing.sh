...
function runSteps () {
    ...
    perl -pe 's#TEST_SAMPLE#$ENV{sample}#g;s#PROJECT#$ENV{project}#g;s#SUBJECT#$ENV{subject}#g;s#DATA_PATH#$ENV{data_path}#g;s#TRIM##g' run_${1}.sh |bsub -J fastqc_${project}_${subject}_${sample}
